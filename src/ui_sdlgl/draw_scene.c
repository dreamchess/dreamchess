...
void draw_scene( board_t *b )
{
    ...
    draw_border(get_ingame_style()->border.textured.image, NULL, 0, gg_rect(20, 440, 170, 20), 8);

    draw_border(get_ingame_style()->border.textured.image, NULL, 0, gg_rect(455, 440, 170, 20), 8);
    ...
    draw_border(get_ingame_style()->border.textured.image, NULL, 0, gg_rect(20, 375, 75, 10), 8);
    draw_border(get_ingame_style()->border.textured.image, NULL, 0, gg_rect(545, 375, 75, 10), 8);
    draw_health_bars();
